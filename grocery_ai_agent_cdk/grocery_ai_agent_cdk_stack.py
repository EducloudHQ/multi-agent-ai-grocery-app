from aws_cdk import (Stack, aws_lambda,
                     ...
                     aws_s3, aws_s3_notifications,
                     aws_lambda_event_sources as lambda_event_sources,
                     aws_stepfunctions as sfn,
                     aws_iam as iam,
                     aws_appsync as appsync, aws_sqs as sqs, aws_dynamodb as dynamodb, Duration, CfnOutput)
from cdklabs.generative_ai_cdk_constructs.bedrock import BedrockFoundationModel, ActionGroupExecutor, ApiSchema, \
    AgentActionGroup, Agent, Guardrail, Topic, PIIFilter, GuardrailAction

from constructs import Construct
from aws_cdk.aws_lambda import Runtime, FunctionUrlAuthType, FunctionUrlCorsOptions, HttpMethod, InvokeMode
...
class GroceryAiAgentCdkStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        batch_upload_products_lambda_function = PythonFunction(
            self, "BatchUploadProductsLambda",
        ...
        batch_upload_products_lambda_function.add_environment("ECOMMERCE_TABLE_NAME", ecommerce_table.table_name)
        # Add Lambda as a DataSource for AppSync
        lambda_ds = api.add_lambda_data_source("LambdaDataSource", batch_upload_products_lambda_function)
        ...
        # Add Lambda as a DataSource for AppSync
        create_stripe_products_lambda_ds = api.add_lambda_data_source("CreateStripeProductsLambdaDataSource",
        ...
        trigger_step_function_products_lambda_function = PythonFunction(
            self, "TriggerStepFunctionsWorkflow",
            runtime=Runtime.PYTHON_3_11,
        ...
        grocery_list_bucket = aws_s3.Bucket(self, "grocery-list-bucket",
                                            versioned=False,
                                            encryption=aws_s3.BucketEncryption.S3_MANAGED,
                                            block_public_access=aws_s3.BlockPublicAccess.BLOCK_ALL)

        # Step 3: Grant the Lambda function permissions to read from the S3 bucket
        grocery_list_bucket.grant_read_write(trigger_step_function_products_lambda_function)
        ...
        trigger_step_function_products_lambda_function.add_to_role_policy(textract_policy)
        # Step 5: Add an S3 event trigger to invoke the Lambda function
        notification = aws_s3_notifications.LambdaDestination(trigger_step_function_products_lambda_function)
        ...
        trigger_step_function_products_lambda_function.add_environment("SQS_QUEUE_URL", sqs_queue.queue_url)

        # Step 10: Create the second Lambda function (SQS Poller)
        sqs_poller_lambda = PythonFunction(self, "LambdaSQSPoller",
        ...
        agent_guardrail = Guardrail(self,
        ...
        state_machine = sfn.StateMachine(
            self, "GroceryDocumentTextractStateMachine",
            definition_body=sfn.DefinitionBody.from_string(json.dumps(state_machine_definition)),
            # Use definition_body
        ...
        trigger_step_function_products_lambda_function.add_environment("STATE_MACHINE_ARN",
        ...
        state_machine.grant_start_execution(trigger_step_function_products_lambda_function)
        ...
        CfnOutput(
            self, "InvokeAgentFunctionUrl",
            value=invoke_agent_lambda_url.url
        )
